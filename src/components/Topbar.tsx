...
export function Topbar({title,subtitle,onSession,onMenu}:{title:string;subtitle:string;onSession:()=>void;onMenu:()=>void}){return <>
 <div className="mobileHeader"><button className="btn" onClick={onMenu}><Menu size={24}/></button><strong>Akquise Wolf</strong><button className="btn btnPrimary" onClick={onSession}><Phone size={16}/></button></div>
